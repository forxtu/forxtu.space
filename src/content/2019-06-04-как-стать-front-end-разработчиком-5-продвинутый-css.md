...
_Для использования CSS препроцессора нужно применять компилятор, который преобразует ваш код в чистый CSS. На начальном этапе (без сборщиков проекта) можно установить плагин для_ [_VSCode - Live SASS compiler_](https://marketplace.visualstudio.com/items?itemName=ritwickdey.live-sass)_._
...
#### Пример кода с использованием БЕМ методологии
